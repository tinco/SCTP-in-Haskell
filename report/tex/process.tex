...
It should be noted that the cumbersome accumulating of unordered events could possibly be reduced by introducing helper functions or even syntax sugar like was done for the monadic style. 
