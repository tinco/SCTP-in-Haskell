...
In stream based I/O an application is modeled as a stream of inputs mapping to a stream of outputs. Examples are taken from "History of Haskell", sometimes slightly altered where deemed necessary. %ref..
